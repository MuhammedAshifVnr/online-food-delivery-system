...
func (x *MenuItemResponse) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *MenuItemResponse) GetRestaurantId() uint32 {
	if x != nil {
...
func (x *MenuItemResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *MenuItemResponse) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_proto_restaurant_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6e, 0x74, 0x22, 0x24, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x6e, 0x75, 0x49,
	0x74, 0x65, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x22, 0xab, 0x01, 0x0a, 0x10, 0x4d,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x74, 0x61, 0x75, 0x72, 0x61,
	...
	0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x02, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x32, 0x60, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x74,
	0x61, 0x75, 0x72, 0x61, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4b, 0x0a,
	...
	0x75, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x72,
	0x65, 0x73, 0x74, 0x61, 0x75, 0x72, 0x61, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x6e, 0x75, 0x49, 0x74,
	0x65, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f,
...
var file_proto_restaurant_proto_depIdxs = []int32{
	...
	1, // 1: restaurant.RestaurantService.GetMenuItem:output_type -> restaurant.MenuItemResponse
...
func file_proto_restaurant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_restaurant_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_restaurant_proto_msgTypes[1].Exporter = func(v any, i int) any {
