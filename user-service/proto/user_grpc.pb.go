...
type UserServiceClient interface {
	GetUserDetails(ctx context.Context, in *GetUserDetailsRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) GetUserDetails(ctx context.Context, in *GetUserDetailsRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
type UserServiceServer interface {
	GetUserDetails(context.Context, *GetUserDetailsRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) GetUserDetails(context.Context, *GetUserDetailsRequest) (*UserResponse, error) {
